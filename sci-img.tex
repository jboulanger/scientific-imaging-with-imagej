...
\begin{frame} \frametitle{Data repository}
  ...
  % \begin{block}{Datahub \url{datahub.io}}
  % \end{block}

  % \begin{block}{Datahub \url{https://registry.opendata.aws/}}
  % \end{block}
...
\begin{frame} \frametitle{Microscope vendor image formats}
  ...
  %Some standardized image format have also been developed to increase
  %inter-operability:
...
\begin{frame} \frametitle{Multi-dimensional images}
  ...
  \end{itemize} To synchronize two stacks use \menu{Analyze>Tools>Synchronize Windows}
\end{frame}
    ...
    \begin{column}{0.4\textwidth}
      ...
      \begin{tikzpicture}
        \begin{axis}[tuftelike,
            ...
            legend style={at={(1,1.25)},legend columns=2,fill=none,draw=none,font=\tiny}]
...
%%  \begin{frame} \frametitle{Filtering}     square.
